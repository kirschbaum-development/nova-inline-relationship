<template>
    <div class="card shadow-md mb-4">
        <div class="bg-30 flex p-2 border-b border-40">
            <div class="w-1/8 text-left py-2 px-2" v-if="!singular">
            ...
            <div class="w-5/8 flex-grow text-left py-2 px-2">
                <h4 class="font-normal text-80">{{label}} {{id+1}}</h4>
            </div>
            <div class="w-1/4 text-right">
                <button class="btn btn-default btn-icon btn bg-transparent hover:bg-danger text-danger hover:text-white border border-danger hover:border-transparent inline-flex items-center relative mr-3" @click.prevent="removeItem()" title="Delete">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" aria-labelledby="delete" role="presentation" class="fill-current text-0"><path fill-rule="nonzero" d="M6 4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2h5a1 1 0 0 1 0 2h-1v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6H1a1 1 0 1 1 0-2h5zM4 6v12h12V6H4zm8-2V2H8v2h4zM8 8a1 1 0 0 1 1 1v6a1 1 0 0 1-2 0V9a1 1 0 0 1 1-1zm4 0a1 1 0 0 1 1 1v6a1 1 0 0 1-2 0V9a1 1 0 0 1 1-1z"></path></svg>
                </button>
            </div>
        </div>
        <div class="nova-items-field-input-wrapper flex p-2 border-b border-40" v-for="(parameter, attrib) in value" :key="attrib">
            ...
            <div class="w-3/4">
                ...
                <div class="flex help-text error-text text-danger px-2 py-2" v-if="hasError(id, attrib)">
